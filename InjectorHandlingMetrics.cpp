#include "InjectorHandlingMetrics.h"
...
SOFA_DECL_CLASS(InjectorHandlingMetrics)

InjectorHandlingMetrics::InjectorHandlingMetrics()
{
	count = 1;
	startFlag = 0;
	PathLengthLI = 0.0;
...
void InjectorHandlingMetrics::doCollisionResponse()
{
}



void InjectorHandlingMetrics::updatePosition(SReal dt)
{
	//clock_t start = clock();
	// Execuatable code
	//clock_t stop = clock();
...
int MyInjectorHandlingMetricsClass = sofa::core::RegisterObject("This component does nothing.").add<InjectorHandlingMetrics>();
