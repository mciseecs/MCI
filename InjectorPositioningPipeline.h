...
namespace collision
{
class InjectorPositioningPipeline : public sofa::component::collision::ExercisePipeline
{
public:
	SOFA_CLASS(InjectorPositioningPipeline,sofa::component::collision::ExercisePipeline);
	//bool visEffect;
	//bool collisionContinue;
public:
	InjectorPositioningPipeline():cubeCount(0),firstTouchObj(true),lastx(0.0),lastz(0.0),damageCountAllow(true), numTimeSteps(0)
	{
		exerciseId=1;
		objectChanged = false;
	};
