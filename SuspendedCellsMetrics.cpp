#include "SuspendedCellsMetrics.h"
...
SOFA_DECL_CLASS(SuspendedCellsMetrics)

SuspendedCellsMetrics::SuspendedCellsMetrics()
{
	count = 1;
	startFlag = 0;
	PathLengthLI = 0.0;
...
void SuspendedCellsMetrics::doCollisionResponse()
{
}



void SuspendedCellsMetrics::updatePosition(SReal dt)
{
	//clock_t start = clock();
	// Execuatable code
	//clock_t stop = clock();
...
int MySuspendedCellsMetricsClass = sofa::core::RegisterObject("This component does nothing.").add<SuspendedCellsMetrics>();
