#include "AdherentCellsMetrics.h"
...
SOFA_DECL_CLASS(AdherentCellsMetrics)

AdherentCellsMetrics::AdherentCellsMetrics()
{
	count = 1;
	startFlag = 0;
	PathLengthLI = 0.0;
...
void AdherentCellsMetrics::doCollisionResponse()
{
}



void AdherentCellsMetrics::updatePosition(SReal dt)
{
	//clock_t start = clock();
	// Execuatable code
	//clock_t stop = clock();
	...
	else
	{
		...
		HandlePipeline = rootNode->getTreeObject<sofa::component::collision::AdherentCellsInjectionPipeline>();
...
int MyAdherentCellsMetricsClass = sofa::core::RegisterObject("This component does nothing.").add<AdherentCellsMetrics>();
